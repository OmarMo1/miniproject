...
class NS_APP(tk.Tk):
    ...
    def plannen(self):
        ...
        label4.config(text="Reis informatie: \n"
                           "Je vertrekt van %s. \n"
                           "Je einbestemming is %s" %(beginstation, eindstation))
